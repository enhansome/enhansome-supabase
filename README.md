...
* [Angular](https://github.com/supabase/supabase/tree/master/examples/user-management/angular-user-management) ⭐ 108,788 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-09-03 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Expo](https://github.com/supabase/supabase/tree/master/examples/user-management/expo-user-management) ⭐ 108,788 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-09-03 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Flutter](https://github.com/supabase/supabase/tree/master/examples/user-management/flutter-user-management) ⭐ 108,788 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-09-03 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Next.js (TS)](https://github.com/supabase/supabase/tree/master/examples/user-management/nextjs-user-management) ⭐ 108,788 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-09-03 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Nuxt](https://github.com/supabase/supabase/tree/master/examples/user-management/nuxtjs-user-management) ⭐ 108,788 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-09-03 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Nuxt3](https://github.com/supabase/supabase/tree/master/examples/user-management/nuxt3-user-management) ⭐ 108,788 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-09-03 - ![auth](https://img.shields.io/badge/-auth-informational)
* [React](https://github.com/supabase/supabase/tree/master/examples/user-management/react-user-management) ⭐ 108,788 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-09-03 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Solid](https://github.com/supabase/supabase/tree/master/examples/user-management/solid-user-management) ⭐ 108,788 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-09-03 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Svelte](https://github.com/supabase/supabase/tree/master/examples/user-management/svelte-user-management) ⭐ 108,788 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-09-03 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Svelte Kit](https://github.com/supabase/supabase/tree/master/examples/user-management/sveltekit-user-management) ⭐ 108,788 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-09-03 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Vue 3](https://github.com/supabase/supabase/tree/master/examples/user-management/vue3-user-management) ⭐ 108,788 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-09-03 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Next.js, Slack Clone](https://github.com/supabase/supabase/tree/master/examples/slack-clone/nextjs-slack-clone) ⭐ 108,788 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-09-03 - ![realtime](https://img.shields.io/badge/-realtime-orange)
* [Svelte, Todo list](https://github.com/supabase/supabase/tree/master/examples/todo-list/sveltejs-todo-list) ⭐ 108,788 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-09-03 - ![database](https://img.shields.io/badge/-database-9cf)
...
* [SupaSocial](https://github.com/koji0701/supabase-react-social-media-starter/tree/main) ⭐ 27 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-13 - React social media starter with auth, friend requests, profile pics, and example app (profile, friends, signin, leaderboard, and more pages).
...
* [Supabase automated self host](https://github.com/singh-inder/supabase-automated-self-host) ⭐ 501 | 🐛 1 | 🌐 Shell | 📅 2026-08-25 - Self-host Supabase with Caddy and Authelia. Just run ONE script.
